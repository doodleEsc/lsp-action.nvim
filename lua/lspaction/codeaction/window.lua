...
M.open = function(opts)
  ...
  cmd 'autocmd CursorMoved <buffer> lua require("lspaction.codeaction.window").set_cursor()'
  cmd "autocmd QuitPre <buffer> lua require('lspaction.codeaction.window').close()"
